...
#             tracks.T_Px, tracks.T_Py, tracks.T_Pz, PiPlus.mass/1000)
#         self.EventsVectors = tlv.TLorentzVectorArray(
#             tracks.groupby('entry').T_Px.sum(), tracks.groupby('entry').T_Py.sum(), tracks.groupby('entry').T_Pz.sum(), 4*(PiPlus.mass/1000))
